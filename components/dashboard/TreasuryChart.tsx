    ...
    <div className="bg-[#0f1e3d] border border-[#30363D] rounded-2xl p-5">
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex gap-3 text-[10px]">
          ...
          <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#F08900] inline-block" />Solde</span>
        </div>
      </div>
          ...
          <ComposedChart data={data} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
            <defs>
              ...
              <linearGradient id="gradSolde" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#F08900" stopOpacity={0.2} />
            ...
            <Area type="monotone" dataKey="solde" name="Solde" stroke="#F08900" strokeWidth={2.5} fill="url(#gradSolde)" dot={false} activeDot={{ r: 5, fill: '#F08900' }} />
          </ComposedChart>
        </ResponsiveContainer>
      )}
    </div>
