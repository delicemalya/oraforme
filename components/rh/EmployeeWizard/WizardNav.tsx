...
export function WizardNav({ steps, currentStep, completedSteps, onGoTo }: WizardNavProps) {
  ...
  return (
    <>
      ...
      {/* ── Mobile / Tablette: barre de progression + label courant ────────── */}
      <div className="lg:hidden space-y-2 mb-4">
        <div className="flex items-center justify-between text-xs text-slate-500">
          <span>
            {visible.findIndex(s => s.id === currentStep) + 1} / {visible.length}
          </span>
        ...
        {/* Pastilles scrollables horizontal */}
