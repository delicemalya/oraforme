  ...
  return (
    <div className="flex h-screen bg-[var(--surface)] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        {/* Admin header */}
        <header className="h-14 bg-[var(--card-bg)] border-b border-[var(--border)] flex items-center px-4 lg:px-6 shrink-0">
          ...
          <div className="ml-auto flex items-center gap-2">
            <div className="w-7 h-7 rounded-full bg-[#DC2626]/20 border border-[#DC2626]/30 flex items-center justify-center">
              <span className="text-[#DC2626] text-xs font-bold">A</span>
            </div>
