  ...
  return (
    <div className="min-h-screen bg-[#0D1117] text-[#E6EDF3]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-[#21262D]/80 bg-[#0D1117]/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/register"
              className="px-4 py-2 rounded-lg bg-[#F0A30A] text-[#0D1117] text-sm font-semibold hover:bg-[#D4910A] transition-colors">
              Créer un compte
            </Link>
          </div>
        </div>
      ...
      <section className="relative pt-40 pb-28 px-6 overflow-hidden">
        {/* Background glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-[#F0A30A]/5 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute top-20 left-1/4 w-[300px] h-[300px] bg-[#F0A30A]/3 rounded-full blur-3xl pointer-events-none" />

        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#F0A30A]/30 bg-[#F0A30A]/5 text-[#F0A30A] text-xs font-medium mb-6">
            <span className="w-1.5 h-1.5 rounded-full bg-[#F0A30A] animate-pulse" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/register"
              className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-[#F0A30A] text-[#0D1117] text-base font-bold hover:bg-[#D4910A] transition-all shadow-lg shadow-[#F0A30A]/20 hover:shadow-[#F0A30A]/30">
      ...
      <section id="secteurs" className="px-6 py-20 border-t border-[#21262D]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-8">
            <Link href="/register"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#F0A30A]/10 border border-[#F0A30A]/20 text-[#F0A30A] text-sm font-medium hover:bg-[#F0A30A]/15 transition-all">
              Choisir mon secteur →
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-[#161B22] border border-[#21262D] rounded-2xl p-12 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/register"
                  className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-[#F0A30A] text-[#0D1117] font-bold hover:bg-[#D4910A] transition-all shadow-lg shadow-[#F0A30A]/20">
