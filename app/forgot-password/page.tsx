      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          <div className="bg-[#0f1e3d] border border-[#30363D] rounded-xl p-10">
            ...
            <Link href="/login" className="inline-flex items-center gap-1.5 text-sm text-[#F08900] hover:underline">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#0f1e3d] border border-[#30363D] rounded-xl p-8">
          ...
          <p className="text-center text-sm text-[#8B949E] mt-6">
            <Link href="/login" className="inline-flex items-center gap-1 text-[#F08900] hover:underline">
