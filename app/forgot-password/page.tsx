      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          <div className="bg-[#161B22] border border-[#30363D] rounded-xl p-10">
            ...
            <h2 className="text-lg font-bold text-[#E6EDF3] mb-2">Email envoyé</h2>
            <p className="text-sm text-[#8B949E] leading-relaxed mb-4">
              Un lien de réinitialisation a été envoyé à{' '}
              <span className="text-[#E6EDF3] font-medium">{email}</span>.
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#8B949E] text-sm mt-1">Réinitialiser votre mot de passe</p>
        </div>

        <div className="bg-[#161B22] border border-[#30363D] rounded-xl p-8">
          <h1 className="text-base font-semibold text-[#E6EDF3] mb-1">Mot de passe oublié ?</h1>
