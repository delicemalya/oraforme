    ...
    <div style="padding:32px">
      ...
      <div style="background:#f8f8f8;border-radius:6px;padding:20px;margin:24px 0">
        <table style="width:100%;font-size:14px">
          ...
          <tr style="border-top:2px solid #ddd"><td style="color:#333;padding:10px 0 0;font-weight:bold;font-size:16px">TOTAL TTC</td><td style="text-align:right;font-weight:bold;font-size:16px;color:#F0A30A;padding-top:10px">${fmt(facture.total ?? 0)}</td></tr>
        </table>
      </div>
