  ...
  return (
    <div style={{ padding: '24px', fontFamily: 'Inter, sans-serif', color: '#0F172A' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
        <button onClick={() => router.push('/dashboard/ong')} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: '20px' }}>←</button>
        <div>
          <h1 style={{ fontSize: '22px', fontWeight: 700, margin: 0 }}>Dons & Collecte</h1>
          <p style={{ color: '#64748B', margin: '4px 0 0', fontSize: '14px' }}>Enregistrement des dons, subventions et affectation aux programmes</p>
        </div>
      </div>
      ...
      <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: '12px', padding: '48px', textAlign: 'center', color: '#94A3B8' }}>
        ...
        <div style={{ fontSize: '18px', fontWeight: 600, color: '#64748B', marginBottom: '8px' }}>Dons & Subventions</div>
        <div style={{ fontSize: '14px', maxWidth: '400px', margin: '0 auto' }}>
          Enregistrement des dons ponctuels et récurrents, gestion des subventions bailleurs, reçus fiscaux et affectation par programme.
          Utilisez la Trésorerie pour enregistrer les entrées de fonds dès maintenant.
        </div>
        <button
          onClick={() => router.push('/dashboard/tresorerie')}
