...
const SECTOR_MODULE_DEFS: Record<string, ModuleDef[]> = {
  ecole: [
    ...
    { id: 'direction',       label: 'Direction',       sublabel: 'Finances & pilotage',  icon: BarChart2,      color: '#388BFD' },
    { id: 'rh',              label: 'RH & Paie',       sublabel: 'Personnel',            icon: Users,          color: '#2EA043' },
    { id: 'comptabilite',    label: 'Comptabilité',    sublabel: 'OHADA',                icon: Calculator,     color: '#8B5CF6' },
  ...
  restaurant: [
    ...
    { id: 'rh',         label: 'RH & Paie',  sublabel: 'Personnel',  icon: Users,     color: '#388BFD' },
    { id: 'tresorerie', label: 'Trésorerie',  sublabel: 'Finances',   icon: Wallet,    color: '#8B5CF6' },
  ...
  default: [
    ...
    { id: 'rh',           label: 'RH',           sublabel: '',          icon: Users,     color: '#388BFD' },
    { id: 'tresorerie',   label: 'Trésorerie',   sublabel: '',          icon: Wallet,    color: '#8B5CF6' },
    { id: 'comptabilite', label: 'Comptabilité', sublabel: '',          icon: BookOpen,  color: '#8B5CF6' },
