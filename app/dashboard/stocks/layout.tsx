...
const STOCK_MODULES = [
  ...
  { href: '/dashboard/stocks/transferts',        label: 'Transferts',      icon: Shuffle },
  { href: '/dashboard/stocks/multi-unites',      label: 'Multi-unités',    icon: Scale },
  { href: '/dashboard/stocks/codes-barres',      label: 'Codes-barres',    icon: QrCode },
  ...
  { href: '/dashboard/stocks/audit',             label: 'Audit',           icon: Shield },
]
