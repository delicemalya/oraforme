  ...
  if (tenantLoading || loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="w-6 h-6 border-2 border-[#F0A30A] border-t-transparent rounded-full animate-spin" />
      </div>
    )
  }
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
        ...
        <div className="flex gap-2">
          ...
          <Link href="/dashboard/restaurant/cuisine"
            className="flex items-center gap-2 px-4 py-2 rounded-lg border border-[#F0A30A]/40 text-[#F0A30A] text-xs font-semibold hover:bg-[#F0A30A]/10 transition-colors">
                ...
                return (
                  <>
                    ...
                    <button onClick={passerCommande} disabled={savingCmd}
                      className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#F0A30A] text-[#0D1117] text-sm font-bold hover:bg-[#F0A30A]/90 disabled:opacity-50 transition-colors">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              ...
              <Link href="/dashboard/restaurant/cuisine"
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#F0A30A]/10 border border-[#F0A30A]/30 text-[#F0A30A] text-xs font-semibold">
                    ...
                    {cols.map(cmd => (
                      <div key={cmd.id} className="bg-[#0D1117] border border-[#21262D] rounded-lg p-3">
                        ...
                        <div className="flex items-center justify-between gap-1">
                          <span className="text-xs font-bold text-[#F0A30A]">{fmtFCFA(cmd.total)}</span>
        ...
        <div className="space-y-5">
          <div className="bg-[#161B22] border border-[#30363D] rounded-xl p-5">
            ...
            <button onClick={addTable} disabled={addingTable || !tableForm.numero}
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#F0A30A] text-[#0D1117] text-sm font-semibold hover:bg-[#F0A30A]/90 disabled:opacity-50 transition-colors">
              ...
              <div>
                ...
                <div className="border border-dashed border-[#30363D] rounded-xl p-4">
                  ...
                  <button onClick={addRecette} disabled={savingRecette || !recetteForm.article_nom.trim() || !recetteForm.quantite}
                    className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#F0A30A] text-[#0D1117] text-xs font-semibold disabled:opacity-50 transition-colors">
            ...
            <div className="bg-[#161B22] border border-[#F0A30A]/30 rounded-xl p-5">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={saveAchat} disabled={savingAchat || !achatForm.fournisseur_nom.trim() || !achatForm.lignes.length}
                  className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium bg-[#F0A30A] text-[#0D1117] hover:bg-[#F0A30A]/90 disabled:opacity-50 transition-colors">
        ...
        <div className="space-y-5">
            ...
            <div className="bg-[#161B22] border border-[#30363D] rounded-xl p-5">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={chartHeure}>
                  ...
                  <Bar dataKey="total" fill="#F0A30A" radius={[2, 2, 0, 0]} maxBarSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          ...
          <div className="bg-[#161B22] border border-[#30363D] rounded-xl p-5">
            ...
            <button onClick={cloturerCaisse}
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#F0A30A]/10 border border-[#F0A30A]/30 text-[#F0A30A] text-sm font-semibold hover:bg-[#F0A30A]/20 transition-colors">
          ...
          <div className="relative bg-[#161B22] border border-[#30363D] rounded-2xl p-6 w-full max-w-sm shadow-2xl">
            ...
            <div className="flex gap-2">
              ...
              <a href={`/api/resto/receipt/${receipt.commandeId}`} target="_blank" rel="noopener noreferrer"
                className="flex-1 px-4 py-2 rounded-lg text-sm font-medium bg-[#F0A30A] text-[#0D1117] hover:bg-[#F0A30A]/90 transition-colors flex items-center justify-center gap-2">
