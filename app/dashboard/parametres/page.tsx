    ...
    <div className="space-y-4 max-w-3xl">
      ...
      <Link href="/dashboard/parametres/integrations"
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[13px] font-bold text-[#0F172A]">Intégrations</p>
            <p className="text-[11px] text-[#166534]">WhatsApp Business, notifications automatiques, alertes fiscales</p>
          </div>
        </div>
